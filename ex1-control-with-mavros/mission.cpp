...
int main(int argc, char **argv)
{
    ...
    ros::Rate rate(20); // shairubin: ros::Rate is a type http://wiki.ros.org/roscpp/Overview/Time
    ...
    geometry_msgs::PoseStamped pose; //shairubin: http://wiki.ros.org/geometry_msgs
    ...
    for(int i = 100; ros::ok() && i > 0; --i){
        ...
        ros::spinOnce(); // shairubin: http://wiki.ros.org/roscpp/Overview/Callbacks%20and%20Spinning 
        rate.sleep();
    }
